...
public class HttpConnectionLauncher {
	...
	public static void main (String[] args) {
		...
		HttpConnection hc1 = new HttpConnection(true, "http://localhost:8080/TPrestTest/");
		...
		HttpConnection hc2 = new HttpConnection(true, "http://localhost:8080/TPrestTest/home");
		...
		HttpConnection hc5 = new HttpConnection(false, "http://localhost:8080/TPrestTest/objectKey");
