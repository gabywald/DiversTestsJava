...
public class DynamicCompilationV2 {
	...
	public static void main(String[] args) throws Exception {
		// create the source
		File sourceFile   = new File("resources/compilation/Hello.java");
...
//		}
		...
		fileManager.setLocation(StandardLocation.CLASS_OUTPUT, Arrays.asList(new File("resources/compilation/")));
		// Compile the file
